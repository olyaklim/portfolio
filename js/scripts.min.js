...
(function(root, factory) {
        ...
        e[t].addons[n] = {
            setup: function() {
                ...
                if (o = e[t].glbl, "boolean" == typeof s && (s = {
                    ...
                    }), this.bind("open:start", d), this.bind("openPanel:start", d), this.bind("openPanel:start", h), this.bind("close:finish", c), this.opts.offCanvas || d.call(this)
                }
            },
            add: function() {
    ...
    function(e) {
        ...
        function n(n, i, s) {
            ...
            }), C.on(h.events + " panend", function(e) {
                m > 0 && e.preventDefault()
            }), C.on(h.events, function(e) {
...
$(function() {
    $(document).ready(function() {
        $("#my-menu").mmenu({
            extensions: {
                all: ["theme-white", "effect-menu-zoom", "effect-panels-zoom", "fx-menu-slide", "pagedim-black"]
            },
            counters: !0,
            navbar: {
                title: '<span class="icon-list"></span> Меню'
            },
            offCanvas: {
                position: "right"
            },
            navbars: [{
                ...
                position: "bottom",
                content: ['<a href="/"><span class="icon-home"></span> перейти на главную</a>']
            }],
            iconPanels: !1
        });
        var n = $("#my-menu").data("mmenu");
        n.bind("open:start", function() {
            $(".hamburger").addClass("is-active")
        }), n.bind("close:finish", function() {
